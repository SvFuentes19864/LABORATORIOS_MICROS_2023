...
VERIF_BOTONES:
    ...
    GOTO $-1
    BCF INTCON, 0 ; LIMPIA LA BANDERA ((INTCON) and 07Fh), 0
...
C_INT: ; CONFIGURACIÓN DE INTERRUPCIONES
    BANKSEL INTCON
    CLRF INTCON
    BSF INTCON, 6 ; SE HABILITA interrupN LAS INTERRUPCIONES PERIFÉRICAS ((INTCON) and 07Fh), 6
    BSF INTCON, 5 ; SE HABILITA LA INTERRUPCIÓN ((INTCON) and 07Fh), 5
    BSF INTCON, 2 ; SE HABILITA LA BANDERA ((INTCON) and 07Fh), 2

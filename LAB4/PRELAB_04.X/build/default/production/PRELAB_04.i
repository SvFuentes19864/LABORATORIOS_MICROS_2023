...
C_INTERRUPCIONES:
    ...
    BANKSEL INTCON
    CLRF INTCON
    BSF INTCON, 6 ; SE HABILITAN LAS INTERRUPCIONES PERIFÉRICAS ((INTCON) and 07Fh), 6
    BSF INTCON, 3 ; SE HABILITA LA INTERRUPCIÓN ((INTCON) and 07Fh), 3
    BSF INTCON, 0 ; SE HABILITA LA BANDERA DE ((INTCON) and 07Fh), 0
    BSF INTCON, 7 ; SE HABILITAN LAS INTERRRUPCIONES GLOBALES ((INTCON) and 07Fh), 7

...
ITMR1:
    BANKSEL PIR1
    BTFSS PIR1, 0 ; BANDERA ((PIR1) and 07Fh), 0 = 1?
    GOTO ITMR0
...
BIT_0:
    ...
    BCF ((INTCON) and 07Fh), 2 ; BORRAMOS LA BANDERA ((INTCON) and 07Fh), 2
...
C_INT: ; CONFIGURACIÓN DE INTERRUPCIONES
    BANKSEL INTCON
    CLRF INTCON
    BSF INTCON, 6 ; SE HABILITA LAS INTERRUPCIONES PERIFÉRICAS ((INTCON) and 07Fh), 6
    BSF INTCON, 5 ; SE HABILITA LA INTERRUPCIÓN DEL TIMER 0
    BSF INTCON, 3 ; SE HABILITA LA INTERRUPCIÓN ((INTCON) and 07Fh), 3
    BSF PIE1, 0 ; SE HABILITA LA INTERRUPCIÓN DEL TMR1
    BSF INTCON, 7 ; SE HABILITA ((INTCON) and 07Fh), 7 INTERRUPCIONES GLOBALES
...
C_TMR1:
    BANKSEL T1CON
    BCF T1CON, 6
    BSF T1CON, 0 ; HABILITAR TMR1 (((T1CON) and 07Fh), 0)
    BCF T1CON, 1 ; OSCILADOR INTERNO ((T1CON) and 07Fh), 1 FOSC/4
    ...
    BANKSEL PIR1
    BCF PIR1, 0 ; BORRAMOS LA BANDERA DE INTERRUPCIÓN ((PIR1) and 07Fh), 0
...
C_RBIF:
    ...
    BSF WPUB, 0
    BSF WPUB, 1
    BSF WPUB, 2 ; Habilitando los Pullups en ((PORTB) and 07Fh), 0, ((PORTB) and 07Fh), 1 y ((PORTB) and 07Fh), 2

...
unsigned int duty_cycle3 = 0;
unsigned int duty_cycleP = 0;
unsigned int duty_cycleT = 0;
unsigned int pwm_period = 255;
int valor_adc;
...
void main(void) {
    ...
    while (1) {
        ...
        if (carac == 49) {
            ...
            enter();
            char valorrojoStr[4];
            sprintf(valorrojoStr, "%d", POT_ROJO);
            cadena("Valor del potenciometro rojo: ");
            cadena(valorrojoStr);
            enter();

            char valorverdeStr[4];
            sprintf(valorverdeStr, "%d", POT_VERDE);
            cadena("Valor del potenciometro verde: ");
            cadena(valorverdeStr);
            enter();

            char valorazulStr[4];
            sprintf(valorazulStr, "%d", POT_AZUL);
            cadena("Valor del potenciometro azul: ");
            cadena(valorazulStr);
            enter();
            enter();
